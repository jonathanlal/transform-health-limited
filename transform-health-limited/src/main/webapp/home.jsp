...
})(window,document,'script','dataLayer','GTM-TVMXRRP');</script>
...
<%-- <c:import url="/includes/bootstrap_js.html"/> --%>
...
body{
/*   background: linear-gradient(to right bottom, #F49916 50%, #D6FAF1 50%); */
