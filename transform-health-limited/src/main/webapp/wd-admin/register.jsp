...
<br><br>
			<div class="justify-content-md-center h-100">
				<div class="card-wrapper text-center">
					...
					<div class="alert alert-danger mb-0 mt-3" role="alert">${error}</div>
					</c:if>
						<div class="card-body">
				  ...
				  <input name="fullname" type="text" class="form-control" placeholder="Full Name" aria-label="Name" required>
				</div>
				  ...
				  <input name="email" type="email" class="form-control" placeholder="Email Address" aria-label="email" required>
				</div>
				  ...
				  <input name="password" type="password" class="form-control" placeholder="Password" aria-label="password" required>
							...
							<div class="form-group no-margin mt-4 text-center">
									<button type="submit" class="btn btn-primary btn-md" style="width:200px;font-weight: 500">
										<i class="fa fa-user-plus pr-1"></i>  REGISTER
									</button>
								</div>
						...
						<div class="margin-top20 text-center">
									Already have an account? <a href="../../wd-admin/login/">Login</a>
								</div>
